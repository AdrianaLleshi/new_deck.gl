define([
    ...
    function xeoViewer(cfg) {
        ...
        this._addObject = function (type, object) {
            var guid = Utils.CompressGuid(object.id.split("#")[1].substr(8, 36).replace(/-/g, ""));
            ...
            // object.material.diffuse = [object.material.diffuse[0] * 0.9, object.material.diffuse[1] * 0.9, object.material.diffuse[2] * 0.9];
        ...
        this.getObject = function(id) {
            return objects[id] || objects_by_guid[objectId];
        };
